    ...
    <div className="bg-white">
      ...
      <header className="relative h-[400px] sm:h-[600px] overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col text-center sm:text-left max-w-screen-md">
          ...
          <p className="text-lg sm:text-xl  mb-6 sm:mb-8 max-w-lg mx-auto sm:mx-0" style={{ color : '#90e0ef'}}>
            Engagement personnel pour vous défendre et protéger
          </p>
          <Link to="/contact" className="bg-[rgba(10,34,64,0.9)] no-underline animate-pulse hover:bg-[rgba(0,119,182,1)]  px-6 sm:px-8 py-2 sm:py-3 rounded-md inline-flex items-center w-fit mx-auto sm:mx-0" style={{ color : '#90e0ef'}}>
            Consultation
