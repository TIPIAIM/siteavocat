      ...
      <header className="relative h-[400px] sm:h-[600px] overflow-hidden">
        ...
        >
          <h1
            ...
            style={{ color: '#90e0ef', fontFamily: 'Georgia, serif' }}
          >
            Cabinet AOD-AVOCATS-SCPA
          </h1>
          <p
            className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-lg mx-auto sm:mx-0"
            style={{ color: '#90e0ef', fontFamily: 'Roboto Slab, serif' }}
          >
        ...
        <div className="container mx-auto px-4 max-w-screen-lg">
          <div className="flex flex-col md:flex-row items-center gap-8 sm:gap-12">
            <div className="flex-1">
              <h2
                className="text-2xl sm:text-3xl text-blue-950 font-bold mb-4 sm:mb-6"
                style={{ fontFamily: 'Roboto Slab, serif' }}
              >
                Notre Cabinet
              </h2>
