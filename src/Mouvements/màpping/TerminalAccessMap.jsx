...
const Shell = styled.section`
  ...
  color: ${c("text", "#EAF2FF")};
  background: radial-gradient(1200px 520px at 10% 0%, ${c("bg2", "rgba(28,63,110,0.25)")}, transparent 60%),
    radial-gradient(900px 480px at 90% 20%, ${c("bg1", "rgba(14,45,79,0.25)")}, transparent 55%),
    ${c("bg", "#0B1220")};
  overflow: hidden;
`;
...
const BgGlow = styled.div`
  ...
  inset: -40px;
  pointer-events: none;
  background: radial-gradient(500px 300px at 15% 20%, ${c("semygprimar", "rgba(242,201,76,0.18)")}, transparent 60%),
    radial-gradient(520px 320px at 85% 10%, ${c("semygsecondary", "rgba(28,63,110,0.22)")}, transparent 62%);
  filter: blur(10px);
...
const MapCard = styled.div`
  ...
  background: linear-gradient(
    180deg,
    ${c("bgducàbinet1", "rgba(255,255,255,0.06)")},
    ${c("bg", "rgba(255,255,255,0.03)")}
  );
...
const MapTopBar = styled.div`
  ...
  padding: 10px;
  border-bottom: 1px solid ${c("border", "rgba(255,255,255,0.10)")};
  background: linear-gradient(180deg, ${c("bg1", "rgba(28,63,110,0.22)")}, transparent);
`;

const ModeGroup = styled.div`
  display: inline-flex;
  border: 1px solid ${c("border", "rgba(255,255,255,0.14)")};
  border-radius: 12px 0 12px 0;
  overflow: hidden;
`;
...
const ModeBtn = styled.button`
  ...
  font-size: 12.5px;
  color: ${c("text", "#EAF2FF")};
  background: ${c("bg1", "rgba(28,63,110,0.18)")};
  transition: transform 0.12s ease, opacity 0.12s ease, background 0.12s ease;

  &[aria-pressed="true"] {
    background: ${c("semygsecondary", "rgba(28,63,110,0.40)")};
  }
...
const Skeleton = styled.div`
  ...
  background: linear-gradient(
    90deg,
    ${c("bg1", "rgba(28,63,110,0.22)")} 0%,
    ${c("bg2", "rgba(28,63,110,0.10)")} 40%,
    ${c("bg1", "rgba(28,63,110,0.22)")} 80%
  );
...
const OverlayChip = styled.span`
  ...
  border-radius: 12px 0 12px 0;
  border: 1px solid ${c("border", "rgba(255,255,255,0.12)")};
  background: ${c("bg1", "rgba(28,63,110,0.24)")};
  color: ${c("text", "#EAF2FF")};
...
const MapFooter = styled.div`
  ...
  gap: 10px;
  padding: 10px;
  border-top: 1px solid ${c("border", "rgba(255,255,255,0.10)")};
  background: linear-gradient(0deg, ${c("bg1", "rgba(28,63,110,0.18)")}, transparent);
`;
...
const SmallAction = styled.button`
  ...
  cursor: pointer;
  border: 1px solid ${c("border", "rgba(255,255,255,0.14)")};
  background: linear-gradient(135deg, ${c("semygprimary", "#0E2D4F")}, ${c("semygsecondary", "#1C3F6E")});
...
const SideCard = styled.div`
  ...
  background: linear-gradient(
    180deg,
    ${c("bgducàbinet1", "rgba(255,255,255,0.07)")},
    ${c("bg", "rgba(255,255,255,0.03)")}
  );
  box-shadow: 0 18px 50px rgba(0, 0, 0, 0.35);
  padding: 14px;
...
const Btn = styled.button`
  ${baseBtn}
  background: ${c("bg1", "rgba(28,63,110,0.25)")};
  color: ${c("text", "#EAF2FF")};
`;
...
const Alert = styled.div`
  ...
  background: ${c("bg1", "rgba(28,63,110,0.22)")};
  font-size: 12.5px;
`;
...
const ToastBox = styled.div`
  ...
  border: 1px solid
    ${({ $type }) =>
      $type === "ok"
        ? c("semygprimar", "rgba(242,201,76,0.45)")
        : $type === "error"
        ? "rgba(255, 99, 99, 0.55)"
        : c("border", "rgba(255,255,255,0.14)")};
  background: ${c("bg1", "rgba(28,63,110,0.35)")};
  color: ${c("text", "#EAF2FF")};
  box-shadow: 0 18px 50px rgba(0, 0, 0, 0.35);
`;
